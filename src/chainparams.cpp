...
{
    const char* pszTimestamp = "ENC affordable turnkey masternode solutions.";
    const CScript genesisOutputScript = CScript() << ParseHex("045f27617a4b711580cb540afdbe821fdfcce499cff3f57d42e4f6748d0c227f6c8a81dffb75511c927ae109ecb5ac950ce3aed18ababec21e2d89c04e5214a5d3") << OP_CHECKSIG;
...
public:
    CMainParams() {
       ...
       // The best chain should have at least this much work.
        ...
        vAlertPubKey = ParseHex("0425d70f0c8b7972bd4ccf614785cf1359febc15fe0088798f71e8833ca8777e8b759005dc7b8098a492f74600cf0ea35ea7c5827039f87afe5889a0c36203f737");
        nDefaultPort = 17111;
        ...
        // Easynodecoin BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        strSporkPubKey = "0402ef2fdb593ca02dc7da9e03c88587100c163cae5eef032513bb368872fb0c103b97cf0e55db7e76634e7dc1bf7e3b125fcbf84ba6d3f7c486e208065b848d29";
...
public:
    CTestNetParams() {
        ...
        // Testnet Easynodecoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Easynodecoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Easynodecoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Easynodecoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CRegTestParams() {
        ...
        // Regtest Easynodecoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Easynodecoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Easynodecoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Easynodecoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Easynodecoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
